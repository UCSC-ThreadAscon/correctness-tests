typedef int this_resolves_iso_error;   // does nothing except making file contain something 
// the line above resolves the error "ISO C requires a translation unit to contain at least one declaration"
